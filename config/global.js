...
module.exports = {
  ...
  quotes: [
    ...
    {
      text:
        "Suppose I should say to a wrestler, 'Show me your muscle'. And he should answer me, 'See my dumb-bells'. Your dumb-bells are your own affair; I want to see the effect of them.  \"Take the treatise 'On Choice', and see how thoroughly I have perused it. I am not asking about this, O slave, but how you act in choosing and refusing, how you manage your desires and aversions, your intentions and purposes, how you meet events -- whether you are in harmony with nature's laws or opposed to them. If in harmony, give me evidence of that, and I will say you are progressing; if the contrary, you may go your way, and not only comment on your books, but write some like them yourself; and what good will it do you?",
      author: "Epictetus",
    },
    {
      text:
    ...
    {
      text: "İnsanın zaten bildiğini sandığı şeyi öğrenmesi imkansızdır.",
      author: "Epictetus",
    },
    {
      text:
    ...
    {
      text:
        "Rahatsız edici bir sorunun sakin bir şekilde üstesinden gelmek, benim içsel huzurum için ödediğim bedeldir. Kaygı ve endişeden özgür kalmam için ödediğim şeydir; işe yaramaz bir şey için değil.",
      author: "Epictetus",
    },
    {
      text:
    ...
    {
      text:
        "Hãy vứt ngay đi cái gì không phải của ta. Hãy thanh lọc các ý kiến của bạn để cái gì không thuộc về bạn sẽ không bám lấy bạn, đừng có dính vào đó và cũng đừng đau khổ khi người ta tước bỏ của bạn cái thứ không thuộc về bạn đó.",
      author: "Epictetus",
    },
    {
      text:
    ...
    {
      text: "Никто не свободен, если он не господин самому себе.",
      author: "Epictetus",
    },
    {
    ...
    {
      text: "كئيبة تلك الحياة التي يشعر الانسان بالخجل لقبولها.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "من ليس لديه شئ يأمل فيه ليس أمامه شئ ييأس منه .",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "Упоритата добрина побеждава и най-лошото сърце.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "يجب عدم المحافظة على حياة يشعر الانسان بالخجل لقبولها.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'Iniquum est collapsis manum non porrigere: commune hoc ius generis humani est" (It is wrong not to stretch out your hand to the fallen: that is a common law of the human race)',
      author: "Seneca",
    },
    {
      text:
    ...
    { text: "صادقُ أمام الجميع كاذبُ أمام نفسه.", author: "Seneca" },
    ...
    { text: "Chi è dappertutto, non è da nessuna parte.", author: "Seneca" },
    {
    ...
    {
      text:
        "Ubicumque ex aequo ad caelum erigitur acies, paribus intervallis omnia divina ab omnibus humanis distant - From whatever point on the earth's surface you look up to heaven the same distance lies between the realms of gods and men",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "No es que dispongamos de poco tiempo, es más bien que perdemos mucho.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "It does not make any difference what a man say; what matters is how he feels, and not how he feels on one particular day but how he feels at all times.",
      author: "Seneca",
    },
    {
    ...
    {
      text:
        "Treat your inferiors in the way in which you would like to be treated by your own superiors. And whenever it strikes you how much power you have over your slave, let it also strike you that your own master has just as much power over you.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Where, then, lies the mistake, since all men crave the happy life?  It is that they regard the means for producing happiness as happiness itself, and, while seeking happiness, they are really fleeing from it. For",
      author: "Seneca",
    },
    {
      text:
        "We all rush through life torn between a desire for the future and a weariness of the present. But he who devotes his time to his own needs, who plans out every day as if it were his last, neither longs for nor fears for tomorrow. How",
      author: "Seneca",
    },
    {
      text:
        "None of it lay fallow and neglected, none of it under another’s control; for being an extremely thrifty guardian of his time he never found anything for which it was worth exchanging. So he had enough time; but those into whose lives the public have made great inroads inevitably have too little.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'Despise everything that useless toil creates as an ornament and an object of beauty. And reflect that nothing except the soul is worthy of wonder; for to the soul, if it be great, naught is great."[4]',
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "I never spend a day in idleness; I appropriate even a part of the night for study. I do not allow time for sleep but yield to it when I must, and when my eyes are wearied with waking and ready to fall shut, I keep them at their task. 2. I have withdrawn not only from men, but from affairs, especially from my own affairs; I am working for later generations, writing down some ideas that may be of assistance to them.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "ما أصعب أن تتخلص النفس من الغضب بعد أن تُدفع إليه.",
      author: "Seneca",
    },
    {
      text:
    ...
    { text: "من يستفيد من جريمة فهو فاعلها.", author: "Seneca" },
    {
      text:
    ...
    {
      text:
        "نار (الحب) عمياء إذ تغذيها (رياح) الغضب ،لاتريد الرضوخ ، لا تحتمل القيود ، لا تهاب الموت ، تهفو إلى مواجهة السيوف وجهاً لوجه.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "no genius that ever won acclaim did so without a measure of indulgence. Name me any man you like who had a celebrated reputation, and I’ll tell you what the age he lived in forgave him, what it turned a blind eye to in his work.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "الطريق المألوف لا يكلف أحداً مشقة ، أسلك طريقاً كان آمناً لأشخاص سابقين ، لا تخرق - أيها الطائش - قوانين الكون المقدسة إلى أبعد الحدود.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Am I not to inquire into the identity of the artist of this universe?",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "ако вървиш с очи,винаги обърнати към слънцето,ти никога няма да видиш сянка.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Why, indeed, is it necessary to summon trouble, – which must be endured soon enough when it has once arrived, or to anticipate trouble and ruin the present through fear of the future? It is indeed foolish to be unhappy now because you may be unhappy at some future time. 2.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "but the most wretched are those who are toiling not even at their own preoccupations, but must regulate their sleep by another’s, and their walk by another’s pace, and obey orders in those freest of all things, loving and hating. If such people want to know how short their lives are, let them reflect how small a portion is their own.",
      author: "Seneca",
    },
    {
      text:
        "We are indeed apt to ascribe certain faults to the place or to the time; but those faults will follow us, no matter how we change our place.  You",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "No man finds it difficult to return to nature, except the man who has deserted nature.  We",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "all the works of mortal man have been doomed to mortality, and in the midst of things which have been destined to die, we live!",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'The fool, with all his other faults, has this also, he is always getting ready to live."[3] Reflect,',
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "it is while Fortune is kind that it should fortify itself against her violence.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "You live as if you will live forever, no care for your mortality ever enters your head, you pay no mind to how much time has already gone by. You waste time as if it was a limitless resource, when any moment you spend on someone else or some matter is potentially your last.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "The longer people extend their colonnades, the higher they build their towers, the wider they stretch their walks, the deeper they dig their summer grottoes, the more massively they raise the roofs of their dining-halls, so much the more will there be to cut off the sight of heaven.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "Докато човек е жив, не трябва да губи надежда.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Therefore it is better to conquer our grief than to deceive it. For if it has withdrawn, being merely beguiled by pleasures and preoccupations, it starts up again and from its very respite gains force to savage us.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "I am, however, discussing with you troubles which concern us both, and sharing the remedy with you, just as if we were lying ill in the same hospital. Listen to me, therefore, as you would if I were talking to myself. ",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Consider, too, that a man lifting his head from the very funeral pyre must need some novel vocabulary not drawn from ordinary everyday condolence to comfort his own dear ones.",
      author: "Seneca",
    },
    {
    ...
    {
      text:
        "But let him consider that those disorders which are so dangerous that they have gained ground in spite of treatment can generally be treated by opposite methods.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Life is divided into three parts: what was, what is and what shall be. Of these three periods, the present is short, the future is doubtful and the past alone is certain. Only",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Why do you wait,” asks he. “Why are you idle? If you don’t seize the day, it escapes.” Even though you seize it, it still will flee; therefore you must compete with time’s haste in the speed of using it, and, like a gush of water that blasts past and will not always flow calmly, you must drink fast.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Where you arrive does not matter so much as what sort of person you are when you arrive there. We",
      author: "Seneca",
    },
    {
    ...
    {
      text:
        "What good does it do you to go overseas, to move from city to city? If you really want to escape the things that harass you, what you’re needing is not to be in a different place but to be a different person. Suppose",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Silently time sneaks up on you, each hour  gone is followed by a worse one.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Leisure without books is death, and burial of a man alive.” “Desultory",
      author: "Seneca",
    },
    {
      text:
        'Hence, the wise man accustoms himself to coming trouble, lightening by long reflection the evils which others lighten by long endurance. We sometimes hear the inexperienced say: "I knew that this was in store for me." But the wise man knows that all things are in store fore him. Whatever happens, he says: "I knew it.',
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'Plato says: "Every king springs from a race of slaves, and every slave has had kings among his ancestors." The flight of time, with its vicissitudes, has jumbled all such things together, and Fortune has turned them upside down.  Then',
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Those who wish their virtue to be advertised are not striving for virtue but for renown. Are you not willing to be just without being renowned? Nay, indeed you must often be just and be at the same time disgraced. And then, if you are wise, let ill repute, well won, be a delight.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "do you know why we have not the power to attain this Stoic ideal? It is because we refuse to believe in our power. Nay, of a surety, there is something else which plays a part: it is because we are in love with our vices; we uphold them and prefer to make excuses for them rather than shake them off.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "nimic nu e mai odios înţelepciunii decât o subtilitate excesivă",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "...those who forget the past, neglect the present, and fear for the future have a life that is very brief and troubled […] They lose the day in expectation of the night, and the night in fear of the dawn.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "By the toil of others we are led into the presence of things which have been brought from darkness into light. We are excluded from no age, but we have access to them all;",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Why are you idle? If you don’t grasp it first, it flees.’ And even if you do grasp it, it will still flee. So you must match time’s swiftness with your speed in using it, and you must drink quickly as though from a rapid stream that will not always flow. In",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "Някои неписани закони са по-устойчиви от всички писани.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Disposons donc notre esprit à prendre en gré tout ce qui arrivera, et surtout que la pensée de notre fin ne nous afflige pas. Il faut faire ses préparatifs pour la mort avant que de songer aux provisions pour la vie",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "C’est la nature, dis-tu, qui me donne tous ces biens. Ne vois-tu pas qu’en parlant ainsi tu ne fais que changer le nom de Dieu ? La nature est-elle autre chose que Dieu et la raison divine, incorporée au monde entier et à chacune de ses parties ?",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Lay hold of today's task, and you will not need to depend so much upon to-morrow's. While",
      author: "Seneca",
    },
    {
    ...
    {
      text:
        "not to give in to adversity, never to trust prosperity, and always take full note of fortune’s habit of behaving just as she pleases, treating her as if she were actually going to do everything it is in her power to do. Whatever you have been expecting for some time comes as less of a shock.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "But you never deign to look at yourself or listen to yourself. So you have no reason to claim credit from anyone for those attentions, since you showed them not because you wanted someone else’s company but because you could not bearyour own.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "If you wish to fear nothing, consider that all things are to be feared.",
      author: "Seneca",
    },
    ...
    {
      text:
        "أما أولئك الذين تمضي حياتهم ببطء وهم يتألمون فالحياة بالنسبة لهم هي الموت.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "It is not the man who has too little, but the man who craves more, that is poor. What",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "You live as though you were going to live for ever, at no time taking thought for your weakness, and you fail to note how much time has already passed by; you waste hours as though you were drawing from a well that was full to overflowing, though all the while that very day you are giving to some person or thing is possibly your last.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "You live as though you were going to live for ever, at no time taking thought for your weakness, and you fail to note how much time has already passed by.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Again, when my mind is lifted up by the greatness of its thoughts, it becomes ambitious for words and longs to match its higher inspiration with its language, and so produces a style that conforms to the impressiveness of the subject matter.",
      author: "Seneca",
    },
    {
      text:
        "The one to whom nothing was refused, whose tears were always wiped away by an anxious mother, will not abide being offended. —  2.21.6",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "Който не умее да мълчи, той не е способен да говори.",
      author: "Seneca",
    },
    {
      text: "Преди да кажеш нещо на другите, кажи го на себе си.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "No man will ever be happy if tortured by the greater happiness of another.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 27 LA VIRTÙ È FONTE DI FELICITÀ Resta ancora molto lavoro a cui tu, di persona, devi dedicare le tue veglie, le tue fatiche, se desideri che sia portato a compimento. A differenza di altri generi di lavoro, questo non ammette deleghe o aiuti.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "But our friend Bassus stays sharp minded. Philosophy furnishes him with this: to be cheerful when death comes in view, to stay strong and happy no matter what one’s bodily condition,",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 20 I FATTI DEVONO ANDARE D'ACCORDO CON LE PAROLE Certo, il lettuccio e i panni rozzi non sono una prova sufficiente per dimostrare la buona disposizione d'animo, se non risulta chiaro che la povertà è stata scelta liberamente, non già tollerata per necessità.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 36 CONSIGLI PER UN AMICO DI LUCILIO La notte nasconde il sole, ma subito dopo il giorno porta via la notte.",
      author: "Seneca",
    },
    {
      text:
    ...
    { text: "Поспішай до мене, але до себе - насамперед.", author: "Seneca" },
    {
      text:
        "LETTERA 39 BISOGNA DOMINARE LE PASSIONI Nessun nemico ha portato tanta offesa agli uomini quanto le loro passioni.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Za najmilszy rodzaj łaski uważał niewiedzę o tym, co każdy uczynił złego.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 25 DIVERSI MODI DI EDUCAZIONE Col peccatore inveterato penso che bisogni agire con un certo tatto, perché non giunga a disperare di sé stesso.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 13 IL SAGGIO NON SI PREOCCUPA DEL FUTURO Osservali ad uno ad uno: troverai vecchi che ancora brigano per ottenere cariche politiche, o iniziano nuovi viaggi, o intraprendono nuovi affari. Che c'è di più brutto di un vecchio che vuole ricominciare a vivere?",
      author: "Seneca",
    },
    {
      text:
        "LETTERA 31 IL VERO BENE È STRETTAMENTE CONNESSO ALLA VIRTÙ Le voci che egli temeva erano carezzevoli ma isolate. Queste che dobbiamo temere noi non vengono da uno scoglio, ma risuonano tutt'intorno da ogni parte della terra. Perciò devi lasciarti dietro non solo un luogo sospetto per i suoi insidiosi piaceri, ma tutte le città.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 32 ACCELERA I TUOI PROGRESSI SPIRITUALI invero è molto dannoso anche chi fa indugiare, specialmente in una vita così breve, che noi abbreviamo ancor più con la nostra incostanza, ricominciando a viverla ora in un modo ora in un altro: la riduciamo a pezzetti e a brandelli.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "The greatest obstacle to living is expectancy, which hangs upon tomorrow and loses today. You are arranging what lies in Fortune’s control, and abandoning what lies in yours. What are you looking at? To what goal are you straining? The whole future lies in uncertainty: live immediately. Listen",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 11 IL SENSO DEL PUDORE Ci occorre-ripeto-una persona a cui adeguare i nostri costumi: non possiamo correggere le cattive abitudini se non ci riferiamo costantemente a una norma.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 29 BISOGNA CONSIGLIARE A TEMPO UTILE Ho intenzione di avvicinarlo e di mostrargli come egli varrebbe di più se valesse di meno nella stima della folla.",
      author: "Seneca",
    },
    {
      text:
        "revenge is an admission that we have been hurt. That cannot be a great mind which is disturbed by injury. He who has hurt you must be either stronger or weaker than yourself. If he be weaker, spare him: if he be stronger, spare yourself.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Fa una scelta di buoni autori e contentati di essi per nutrirti del loro genio se vuoi ricavarne insegnamenti che ti rimangano. Voler essere dappertutto è come essere in nessu luogo. Non potendo quindi leggere tutti i libri che puoi avere, contentati di avere quelli che puoi leggere.",
      author: "Seneca",
    },
    ...
    {
      text:
        "LETTERA 38 VANTAGGI DELLA CONVERSAZIONE FAMILIARE I discorsi già preparati e pronunciati a gran voce davanti al pubblico degli ascoltatori hanno maggior risonanza, ma meno familiarità. La filosofia non è che un buon consiglio, ma nessuno dà un consiglio ad alta voce.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Gegen die Leidenschaften muss man in kräftigem Ansturm kämpfen, nich tmit bedächtiger Behutsamkeit",
      author: "Seneca",
    },
    {
      text:
        "we are frightened at uncertainties, just as if they were certain. We observe no moderation. The slightest thing turns the scales and throws us forthwith into a panic.",
      author: "Seneca",
    },
    {
      text:
        "LETTERA 17 LA FILOSOFIA GIOVA IN OGNI CIRCOSTANZA DELLA VITA Così non importa se un animo malato sia posto fra le ricchezze o nella povertà: lo seguirà sempre il suo male.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "No one will bring back the years: no one will restore you back to yourself. Life will follow the path it began to take, and will neither reverse nor check its course. What will be the outcome? You have been preoccupied while life hastens on. Meanwhile death will arrive, and you have no choice in making yourself available for that.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'De Epicuro", dizes, "é essa afirmação. O que tem uma outra escola a ver com a nossa? Tudo o que é verdadeiro também é meu.',
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 33 DEVI ACQUISTARE UN PENSIERO ORIGINALE, FRUTTO DELLA TUA ESPERIENZA Ricordare è custodire ciò che è stato affidato alla memoria, mentre sapere significa far proprie le nozioni apprese e non star sempre attaccato al modello, con lo sguardo sempre rivolto al maestro.",
      author: "Seneca",
    },
    ...
    {
      text:
        "LETTERA 21 LA VERA GLORIA In questi giardini gli stimoli della fame non si eccitano, ma si estinguono; né la sere aumenta col bere, ma è sedata da un rimedio naturale e gratuito.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 2 LA LETTURA CHE GIOVA È povero non chi possiede poco, ma chi brama avere di più.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 12 ANCHE LA VECCHIAIA HA LE SUE GIOIE Tutta la nostra esistenza è fatta di parti, è costituita, cioè, di cerchi più ampi che cingono cerchi sempre minori.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Souvenez-vous principalement de séparer les choses du bruit qu’elles font et de les considérer seulement en elles-mêmes. Vous trouverez qu’elles n’ont rien de terrible que la peur qu’on en a",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 22 OCCORRE ABBANDONARE LA VITA PUBBLICA AL MOMENTO GIUSTO Nessuno si preoccupa di una vita virtuosa, ma pensa solo a quanto tempo potrà vivere. Tuttavia tutti possono vivere bene, nessuno ha il potere di vivere a lungo.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "When Zeno received news of a shipwreck and heard that all his luggage had been sunk he said, “Fortune bids me to be a less encumbered philosopher.”   Creation",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "There is nothing the busy man is less busied with than living:  there is nothing that is harder to learn. Of",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'Men are so thoughtless, nay, so mad, that some, through fear of death, force themselves to die." Whichever',
      author: "Seneca",
    },
    { text: "Бывают заблуждения, имеющие видимость истин.", author: "Seneca" },
    { text: "inflicted,", author: "Seneca" },
    { text: "La vera gioia è una cosa seria.", author: "Seneca" },
    ...
    {
      text:
        "LETTERA 4 IL SAGGIO NON TEME LA MORTE Gli uomini, in maggioranza, ondeggiano tra il timore della morte e i tormenti della vita; non hanno il coraggio di vivere, né sanno morire.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Solos aquellos gozan de quietud que se desocupan para admitir la sabiduría, y solos ellos son los que viven; porque no sólo aprovechan su tiempo, sino que le añaden todas las edades, haciendo propios suyos todos los años que han pasado;",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        'El verdadero héroe en una obra literaria es el lector que la aguanta". Séneca.',
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 19 LA VITA TRANQUILLA E I SUOI VANTAGGI Nel tuo modo di vivere non devi distinguerti troppo dagli altri, ma neppure devi rimanere nella completa oscurità.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 37 IL DIFFICILE ESERCIZIO DELLA VIRTÙ La fortuna viene incontro a noi non meno spesso di quanto noi andiamo incontro a lei. È cosa vergognosa, anziché andare verso di lei, lasciarsi trascinare e, presi in mezzo al turbine degli eventi, chiederci con stupore. “Come mai son giunto qui?",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 30 COME AUFIDIO BASSO SI PREPARA ALLA MORTE Noi, più che la morte, temiamo il pensiero della morte. In ogni momento siamo ugualmente distanti dalla morte. Se essa deve essere temuta, dobbiamo temerla sempre, perché nessun periodo è esente dalla morte.",
      author: "Seneca",
    },
    {
      text:
        "Ser siempre dichoso y pasar la vida sin dentelladas en el espíritu es, de cierto, desconocer el otro lado de la naturaleza. Eres un gran hombre, pero ¿Cómo lo sé, si la suerte no te da ocasión de demostrar tu valor?",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "La solitudine è per lo spirito ciò che il cibo è per il corpo.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 16 LA NOSTRA VITA DEVE ESSERE REGOLATA DALLA FILOSOFIA Abbandona, quindi, le vanità e, quando vorrai sapere se i tuoi desideri sono secondo natura oppure ciechi, considera se hanno un termine dove arrestarsi: se, andando avanti nel soddisfare un desiderio, senti sempre più lontano il suo appagamento, sappi che non è un desiderio naturale.",
      author: "Seneca",
    },
    { text: "If you wish to be loved, love.", author: "Seneca" },
    {
      text:
        "Δούλευε σαν να πρόκειται να ζήσεις για πάντα, αγάπα σαν να πρόκειται να πεθάνεις σήμερα.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 34 SODDISFAZIONE PER I PROGRESSI DI LUCILIO Cosa credi che possa provare chi ha educato una coscienza e, mentre ha incominciato a formarla ancora tenera, la vede ad un tratto matura?",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 5 INVITO ALLA SEMPLICITA' Nessuno è infelice solo per il presente.",
      author: "Seneca",
    },
    { text: "Unblest is he who thinks himself unblest.[15]", author: "Seneca" },
    { text: "Tanrı'ya yakın olmak sarsılmamaktır.", author: "Seneca" },
    {
      text: "ليس ثمة عبودية تحقر من صاحبها كالعبودية التى يفرضها هو على نفسه",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "Some men even prepare for whatever lies after death – a necropolis of tombs, countless public dedications, blazing funeral pyres that can be seen from the stars and ostentatious funerals worthy of demi-gods. But in the end, their funerals were just like their lives – over in a short burst of flames.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 18 ELOGIO DELLA POVERTÀ Se non vuoi che uno si affanni e sia preso dal panico di fronte ad una triste realtà, fallo esercitare prima che essa si presenti.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 15: BISOGNA ESERCITARE LO SPIRITO, PIU' CHE IL CORPO Né il freddo, né il caldo, e neppure la vecchiaia, potrà impedire di esercitare le forze dell'animo: cura dunque questo bene, che diventa migliore col passare del tempo.",
      author: "Seneca",
    },
    {
    ...
    {
      text:
        "Epicuro reprova igualmente os que cobiçam a morte e os que a temem, dizendo: “É ridículo correr para a morte entediado com a vida uma vez que foi com teu estilo de vida que provocaste essa corrida para a morte",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text: "„Odmítáme ty co nás milují, a milujeme ty co nás odmítají.",
      author: "Seneca",
    },
    {
      text:
        "¿Qué mayor necedad que alabar en el hombre lo que no le pertenece?",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "LETTERA 23 LA VERA GIOIA Ma è difficile avere il senso della misura riguardo a ciò che si ritiene un bene.",
      author: "Seneca",
    },
    {
      text:
    ...
    {
      text:
        "إذا ما استطاعَ إنسانٌ أن يثبتَ لي أني على خطأ ويبين لي خطئي في أي فكرةٍ أو فعل ، فسوف أُغيِّر نفسي بكل سرور . أن أريدُ إلا الحق ، وهو مطلبٌ لم يضر أي إنسانٍ قط .  إنما الضررُ هو أن يُصرَّ المـرءُ على جهلهِ ويستمر في خداع ذاته .",
      author: "Marcus Aurelius",
    },
    ...
    {
      text:
        'ثورو يقول : " أن تكون فيلسوفًا لا يعني أن يكون لديك أفكار حاذقة, ولا حتى أن تؤسِس مدرسة؛ بل أن تحب الحكمة بحيث تحيا وفقًا لإملاءاتها, حياة بساطة و إستقلال و سماحة و صدق. أن تكون فيلسوفًا هو أن تحلّ بعض مشكلات الحياة, لا حلًا نظريًا فقط, بل عمليًا أيضًا',
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        'لا تُعلّق سعادتك على آرائ الآخرين فيك ولا تضع هناءك في أيديهم. ذلك " استرقاق " طوعي و " مصادرة " حياة و " نفي " خارج الذات. و ما كنت لترضي أيًّا من ذلك لو كنت تعرف إسمه الحقيقي.',
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    { text: "السعي في حد ذاته إلى الفضيلة فضيلة", author: "Marcus Aurelius" },
    {
      text:
    ...
    {
      text: "ألاّ تصير مثل الذي أساء اليك ، ذلك هو خير انتقام",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "تمادي في إيذاء ذاتك أيتها النفس .. إن هي إلا لحظة ولن يعود لديك مُتسع لاعتبار ذاتك . الحياةُ لحظة ، ولحظتك الخاصة تُوشكُ علـى النهاية والسعادة تتعلق على تقدير الذات لذاتها ، ومازلت تحرمينها من ذلك وتعلقين سعادتك على الآخرين",
      author: "Marcus Aurelius",
    },
    ...
    {
      text: "محظوظ ذلك الذي لايخاف ولا يأمل - زينون",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text: "لا أخاف شيئا ولا آمل في شئ إني حر - كازنتزاكيس",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "ما كان يوماُ جَهلُ المرء بما يدور في رءوس الآخرين سبباً للتعاسة والشقاء . أنما الشقي من لا ينتبه إلى خطراتِ عقلهِ هو ، ولا يـهتدي بهديـه وإرشاده",
      author: "Marcus Aurelius",
    },
    {
      text:
        "إن خطيئة الرغبة أجدرُ باللوم من خطيئة الغضب . إذ أن الأولُ أشبه بشخصٍ أُذِيَ فاضرَّه الألمُ إلى الغضب ، أما الثاني فإنه هو مصدر نزوته ومنشأ اندفاعته إلى الأثم حين تحدوه الشهوة إلى ارتكاب ما ارتكب",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text: "الذات الخالية من الانفعالات قلعة وحصن ومنتجع",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "The art of living is more like wrestling than dancing, in as much as it, too, demands a from and watchful stance against any unexpected onset",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        'قيل لزينون "أي الملوك أفضل: ملك اليونانيين أم الفرس؟" قال: "من ملك شهوته وغضبه',
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "الكتابة ارتقاء من الخصوصية إلى العمومية، تحقيق لما هو كامن في العقل، وتحديد لما هو غائم، وتثبيت لما هو هائم. بل هي بحث عن المجهول منن خبايا النفس، ومعرفة بما هو ضائع في تضاعيف الذات.  لست أعرف بالضبط ما أنا أفكر فيه؛ ربما لذلك شرعت في كتابته",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Thou art a little soul bearing about a corpse, as Epictetus used to say. It is no evil for things to undergo change, and no good for things to subsist in consequence of change.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Her şey düşüncenin verdiği biçimi alır. Ve düşüncenizin kontrolü sizin elinizdedir. Dolayısıyla yargılarınızı ortadan kaldırmaya karar verdiğinizde huzura kavuşursunuz. Tıpkı, burnu dolaşan bir denizcinin sakin suya, dalgasız bir koya erişmesi gibi.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Is my understanding sufficient for this or not? If it is sufficient, I use it for the work as an instrument given by the universal nature. But if it is not sufficient, then either I retire from the work and give way to him who is able to do it better,",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    { text: "لاتكن دمية تحركها خيوط الرغبة", author: "Marcus Aurelius" },
    {
      text:
    ...
    {
      text:
        "And not to think of philosophy as your instructor, but as the sponge and egg white that relieve ophthalmia—as a soothing ointment, a warm lotion. Not",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text: "Ninguém vale mais que as suas ambições",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "all these things, which thou seest, change immediately and will no longer be; and constantly bear in mind how many of these changes thou hast already witnessed. The",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Jos jokin tuntuu sinusta vaikealta, niin älä ajattele, että ihminen ei voi sitä kestää. Jos sen sijaan jokin on mahdollista ihmisen suorittaa, niin arvele voivasi itsekin siitä selviytyä.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "То, что было препоной для данного действия, становится средством для другого действия, а то, что стояло на пути, само указует путь",
      author: "Marcus Aurelius",
    },
    {
      text:
        "Если же ты не способен перенести это, то и тогда тебе нечего досадовать, ибо, уничтожив тебя, оно погибнет и само.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Thou hast already had sufficient experience, that of those many things that hitherto thou hast erred and wandered about, thou couldst not find happiness in any of them. Not in syllogisms, and logical subtilties, not in wealth, not in honour and reputation, not in pleasure. In none of all these. Wherein then is it to be found? In the practice of those things, which the nature of man, as he is a man, doth require. How then shall he do those things? If his dogmata, or moral tenets and opinions (from which all motions and actions do proceed), be right and true.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Estás viendo qué pocas son las cosas que debe uno dominar para poder vivir una vida próspera y respetuosa con la divinidad, porque los dioses no exigirán nada más al que mantenga esto.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Now a man should take away not only unnecessary acts, but also, unnecessary thoughts, for thus superfluous acts will not follow after. Try",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "time is fixed for thee, which if thou dost not use for clearing away the clouds from thy mind, it will go and thou wilt go, and it will never return. Every",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text: "no renuncies a ser libre, decente, comunitario, dócil ante dios.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Há fulanos que quando fazem algum favor a alguém estão logo prontos para lançar no livro de contas o agradecimento devido.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Ἕωϑεν προλἐγειν ἑαυτῷ συντεύξομαι περιὲργω, ἀχαρίστῳ, ὑβριστῆ, δολερῷ, βασϰάνω, ἀϰοινωνήτω.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Ведь тот, кто отдал предпочтение своему духу, гению, служению добродетели, не надевает трагической маски, не издает стенаний, не нуждается ни в уединении, ни в многолюдстве. Он будет жить – и это самое главное – ничего не преследуя и ничего не избегая.",
      author: "Marcus Aurelius",
    },
    {
      text: "Aunque sean dos, el camino es uno sólo.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        'Remember what Marcus Aurelius said: "Accept the things to which life binds you, and love the people with whom life brings you together, but do so with all your heart.',
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text: "En tu mano está reavivar continuamente su llama. Puedo",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text:
        "Тебя увлекает мечта о славе? Обрати внимание на то, как быстро все предается забвению, на хаос времени, беспредельного в ту и другую сторону, на суетность похвал, изменчивость и безрассудство тех, которые, по-видимому, тебя ценят, на незначительность пространства, пределами коего слава ограничена.",
      author: "Marcus Aurelius",
    },
    {
      text:
    ...
    {
      text: "Все мимолетно: и тот, кто помнит, и то, о чем помнят.",
      author: "Marcus Aurelius",
    },
    {
